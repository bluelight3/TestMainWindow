...
#include <memory>
#include "../../TestMainWindow/mytextitem.h"
...
QT_MOC_LITERAL(3, 21, 14), // "selectedChange"
QT_MOC_LITERAL(4, 36, 14), // "QGraphicsItem*"
QT_MOC_LITERAL(5, 51, 4) // "item"

    },
    "MyTextItem\0mySignal\0\0selectedChange\0"
    "QGraphicsItem*\0item"
};
...
void MyTextItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (MyTextItem::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyTextItem::mySignal)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MyTextItem::*)(QGraphicsItem * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyTextItem::selectedChange)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MyTextItem::mySignal(QString _t1)
{
...
// SIGNAL 1
void MyTextItem::selectedChange(QGraphicsItem * _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
